...
public class Projet01App {

    private static final Logger log = LoggerFactory.getLogger(Projet01App.class);

    private final Environment env;

    public Projet01App(Environment env) {
        this.env = env;
    }

    /**
     * Initializes Projet01.
     * <p>
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(Projet01App.class);
